/**
 * نظام المعالجة والتحقق البرمجي الرقمي المطور (الإصدار الماسي V4)
...
let currentPdfFileName = "استمارة.pdf";
...
function renderFormsCapsules(monthKey, type) {
    ...
    // تصميم زر التحميل الشامل الأنيق (Pill Design)
...
function buildFormPageHtml(form, type) {
    ...
    for(let key in form) {
        ...
        if(!key.includes("Timestamp") && !key.includes("طابع زمني")) {
            ...
            gridItems += `
                <div style="width: ${itemWidth}; display: flex; flex-direction: column; border: 1.5px solid ${themeColor}; border-radius: 8px; overflow: hidden; box-shadow: 1px 1px 3px rgba(0,0,0,0.05); box-sizing: border-box; background-color: #fff; page-break-inside: avoid;">
    ...
    return `
        <div style="width: 210mm; height: 296mm; background: #fff; padding: 15mm; box-sizing: border-box; font-family: Arial, sans-serif; direction: rtl; position:relative; overflow: hidden; margin: 0 auto;">
            ...
            <div style="position: relative; z-index: 2; padding: 5mm; display: flex; flex-direction: column; height: 100%;">
                ...
                <table style="width: 100%; border: none; margin-bottom: 25px; border-bottom: 2px solid ${themeColor}; padding-bottom: 15px;">
                    <tr>
                        <td style="width: 33%; text-align: right; vertical-align: middle; color: #333;">${headerText}</td>
...
// دالة تبديل المظهر التي تغير الأيقونة في الزر أيضاً
